...
- `cutoff::Real=1e-3` : The minimum value of a term in the binomial weights, lower values will result in a more precise result with a higher computational cost.
